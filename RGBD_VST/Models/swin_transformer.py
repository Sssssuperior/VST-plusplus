...
class PatchEmbed(nn.Module):
    ...
    def __init__(self, img_size=288, patch_size=4, in_chans=3, embed_dim=96, norm_layer=None):
        super().__init__()
...
class SwinTransformer(nn.Module):
    ...
    def __init__(self, img_size=288, patch_size=4, in_chans=3, num_classes=1000,
...
def swin_transformer_S(pretrained=True, **kwargs):
...
def swin_transformer_B(pretrained=True, **kwargs):
    # for swin-B
