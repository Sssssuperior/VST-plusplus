...
class token_trans(nn.Module):
    ...
    def forward(self, fea, saliency_tokens, contour_tokens, sal_PE, con_PE, back_PE, mask):
        B, _, _ = fea.shape
        # fea [B, H*W, 64]
        # project to 384 dim
        ...
        fea,saliency_tokens,contour_tokens,fea_tmp, fea_s = self.encoderlayer(fea, saliency_tokens, contour_tokens, sal_PE, con_PE, back_PE, mask)
...
class Decoder(nn.Module):
    ...
    def forward(self, fea_1_16, saliency_tokens, contour_tokens, fea_16, saliency_tokens_16, contour_tokens_16, saliency_fea_1_16, contour_fea_1_16, rgb_fea_1_8, rgb_fea_1_4, sal_PE, con_PE, back_PE):
        ...
        # token prediction
        fea_1_8, saliency_tokens, contour_tokens, fea_8, saliency_tokens_8, contour_tokens_8,  saliency_fea_1_8, contour_fea_1_8 = self.token_pre_1_8(fea_1_8, saliency_tokens, contour_tokens,  sal_PE, con_PE, back_PE, mask_8)
        ...
        # token prediction
        fea_1_4, saliency_tokens, contour_tokens, fea_4, saliency_tokens_4, contour_tokens_4,saliency_fea_1_4, contour_fea_1_4 = self.token_pre_1_4(fea_1_4, saliency_tokens, contour_tokens,  sal_PE, con_PE, back_PE, mask_4)
        # predict saliency maps and contour maps
