...
class token_TransformerEncoder(nn.Module):
    ...
    def forward(self, fea, saliency_tokens, contour_tokens, sal_PE, con_PE, back_PE, mask=None):
        ...
        patch_PE = rearrange(self.pe_layer(fea_pos, None),'b c h w -> b (h w) c')
...
class token_Transformer(nn.Module):
    ...
    def forward(self, rgb_fea):
        ...
        fea_1_16,saliency_tokens,contour_tokens,fea_16,fea_1_16_s = self.encoderlayer(fea_1_16, saliency_tokens, contour_tokens, sal_PE, con_PE, back_PE)
